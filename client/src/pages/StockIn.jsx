    ...
    <div className="fade-in">
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="stockin-mobile-cards-container">
            {currentDisplayedRecords.map((item) => (
              <div key={item._id} className="card stockin-mobile-card">
                ...
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "12px", color: "#64748b" }}>
                  <span>
                    📅 {new Date(item.receivedDate || item.createdAt).toLocaleDateString("en-GB")}
                  </span>
